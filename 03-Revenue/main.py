...
# Metrics -------------------------------------------------------------------------------
print(f"\n mse: {mean_squared_error(data['Price'][split:-WINDOW-1].values,predictions).round(4)}")
print(f"\n mae: {mean_absolute_error(data['Price'][split:-WINDOW-1].values,predictions).round(4)}")
